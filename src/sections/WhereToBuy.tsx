...
const platforms = [
  ...
  { name: 'Swiggy Instamart', href: 'https://www.swiggy.com/instamart' },
  { name: 'Zepto', href: 'https://www.zeptonow.com/' },
  { name: 'Flipkart Minutes', href: 'https://www.flipkart.com/minutes' },
];

gsap.registerPlugin(ScrollTrigger);

const PlatformCard: React.FC<{ name: string; href: string }> = ({ name, href }) => (
  <a href={href} target="_blank" rel="noopener noreferrer" className="gsap-retailer-tile group block">
