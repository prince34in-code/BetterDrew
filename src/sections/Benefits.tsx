...
const gridCardsData = [
  {
    ...
    className: 'md:col-start-1 md:row-start-1 md:row-span-2 bg-drew-deep-green text-drew-soft-white md:h-[560px]',
  },
  {
    type: 'text',
    title: 'Hydration that fits your day.',
    description: 'A clean source of natural electrolytes, made for everyday moments.',
    className: 'md:col-start-2 md:col-span-2 md:row-start-1 bg-orange-100 text-drew-deep-green md:h-[250px]',
  },
  {
    type: 'image',
    imageUrl: lifestyleImage1,
    alt: 'Woman smiling and holding a bottle of Betterdrew coconut water',
    className: 'md:col-start-2 md:row-start-2 md:h-[290px]',
  },
  {
    type: 'image',
    imageUrl: lifestyleImage3,
    alt: 'Woman holding a bottle of Betterdrew coconut water after a workout',
    className: 'md:col-start-3 md:row-start-2 md:row-span-2 md:h-[560px]',
  },
  {
    type: 'image',
    imageUrl: lifestyleImage2,
    alt: 'Woman meditating with a bottle of Betterdrew coconut water',
    className: 'md:col-start-1 md:row-start-3 md:h-[290px]',
  },
  {
    type: 'text',
    title: 'Simple ingredients.\nA better choice.',
    description: 'No added sugar. No preservatives. Just young coconut water.',
    className: 'md:col-start-2 md:col-span-2 md:row-start-3 bg-rose-200 text-drew-deep-green text-center md:h-[250px]',
  },
];
...
const GridCard = ({
  ...
  if (card.type === 'image') {
    return (
      <div
        className={`grid-card invisible group relative min-h-[240px] md:min-h-0 overflow-hidden rounded-2xl sm:rounded-3xl shadow-soft ${card.className}`}
      >
        <img
          src={card.imageUrl}
          alt={card.alt}
  ...
  return (
    <div
      className={`grid-card invisible relative flex min-h-[240px] flex-col justify-between overflow-hidden rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-soft ${card.className}`}
    >
      <div>
